...
hanoi_main(void)
{
  ...
  tfp_printf("Towers of Hanoi Puzzle Test Program\n");
  tfp_printf("Disks     Moves\n");
...
cipher_main(void)
{
  ...
  tfp_printf("TEA Cipher results:\n");
  tfp_printf("  plaintext:  0x%04X%04X 0x%04X%04X\n",
        plaintext[0] >> 16, plaintext[0] & 0xffff,
               plaintext[1] >> 16, plaintext[1] & 0xffff);
  tfp_printf("  ciphertext: 0x%04X%04X 0x%04X%04X\n",
